/* ==========================================================================
   1. SUPABASE CONFIGURATION (Yahan Apni Details Daalein)
   ========================================================================== */
...
/* ==========================================================================
   7. MODALS & BOOKING EXECUTION (SUPABASE ORDER SYNC)
   ========================================================================== */
function openImageModal(productId) {
    ...
    document.getElementById("hdModalMudra").innerText = `🪙 +${prod.mudra_reward} Mudra Gold Credit`;
...
function openCheckoutModal(prod) {
    ...
    document.getElementById("checkoutMudraCredit").innerText = prod.mudra_reward;
...
// Execute Booking Request and Save to Supabase
    ...
    try {
        if (supabase) {
            const { data, error } = await supabase.from('orders').insert([{
                ...
                product_id: activeProductForBooking.id,
        ...
        currentUser.mudraGold += Number(activeProductForBooking.mudra_reward);
        updateUIHeader();
    ...
    try {
        ...
        container.innerHTML = orders.map(ord => `
            <div style="background:#222; border:1px solid #444; border-radius:6px; padding:10px; margin-bottom:10px;">
                ...
                <p><strong>Item:</strong> ${ord.products?.name || 'Jewelry Product'}</p>
